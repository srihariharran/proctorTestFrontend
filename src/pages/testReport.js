                        ...
                        <React.Fragment>

                            {
                                ...
                                (answer==data && data==correctAnswer)?
                                    <FormControlLabel sx={{border:1}} value={data} control={<Radio checked/>} label={data} key={index}/>
                                :
                                    (answer==data)&&
                                        <FormControlLabel value={data} control={<Radio checked/>} label={data} key={index}/>
                                    ||
                                        (data==correctAnswer)&&
                                            <FormControlLabel sx={{border:1}} value={data} control={<Radio />} label={data} key={index}/>
                                        ||
